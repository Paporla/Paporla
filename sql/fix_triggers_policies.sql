...
-- Función para generar código de recogida (formato: P4P-XXXX-XXXX)
...
-- TRIGGER 2: Generar código de recogida automático al crear reserva
...
-- TRIGGER 3: Actualizar stock automáticamente al crear/cancelar reservas
...
AS $$
BEGIN
  -- Si es una nueva reserva (INSERT) o cambió a confirmed/pending
  ...
  -- Si la reserva se cancela (UPDATE)
