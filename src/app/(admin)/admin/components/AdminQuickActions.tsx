...
const actions = [
  ...
  {
    icon: Package,
    label: 'Gestionar packs',
    description: 'Ver y moderar packs activos',
    href: '/admin/shops',
  ...
  },
  {
    icon: FileText,
    label: 'Estadisticas',
    description: 'Analisis y reportes del sistema',
    href: '/admin/stats',
  ...
  },
  {
    icon: Shield,
    label: 'Comercios',
    description: 'Listado completo de comercios',
    href: '/admin/shops',
    color: 'text-primary',
    bg: 'bg-primary/10',
  },
  {
    ...
    description: 'Eventos importantes de la plataforma',
    href: '/admin',
    color: 'text-red-400',
    bg: 'bg-red-500/10',
  },
