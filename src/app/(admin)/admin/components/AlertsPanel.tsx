...
const levelStyles = {
  critical: { bg: 'bg-red-500/5', border: 'border-red-500/30', iconBg: 'bg-red-500/15', iconColor: 'text-red-400', actionBg: 'bg-red-500/10 hover:bg-red-500/20', actionText: 'text-red-400' },
  warning: { bg: 'bg-amber-500/5', border: 'border-amber-500/30', iconBg: 'bg-amber-500/15', iconColor: 'text-amber-400', actionBg: 'bg-amber-500/10 hover:bg-amber-500/20', actionText: 'text-amber-400' },
  info: { bg: 'bg-blue-500/5', border: 'border-blue-500/30', iconBg: 'bg-blue-500/15', iconColor: 'text-blue-400', actionBg: 'bg-blue-500/10 hover:bg-blue-500/20', actionText: 'text-blue-400' },
  success: { bg: 'bg-green-500/5', border: 'border-green-500/30', iconBg: 'bg-green-500/15', iconColor: 'text-green-400', actionBg: 'bg-green-500/10 hover:bg-green-500/20', actionText: 'text-green-400' },
};
...
export default function AlertsPanel() {
  ...
  const loadAlerts = async () => {
    ...
    if (logs && logs.length > 0) {
      const mappedAlerts: Alert[] = logs.map((log: any) => ({
        id: log.id,
