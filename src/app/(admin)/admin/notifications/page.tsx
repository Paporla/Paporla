...
const typeCounts = {
  new_user: { icon: UserPlus, label: 'Nuevos usuarios', color: 'text-secondary', bg: 'bg-secondary/10' },
  ...
  new_reservation: { icon: ShoppingBag, label: 'Nuevas reservas', color: 'text-primary', bg: 'bg-primary/10' },
}
