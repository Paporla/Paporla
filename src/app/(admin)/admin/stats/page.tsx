    ...
    <div className="space-y-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex items-center gap-4 mb-1">
          ...
          <div>
            <h1 className="text-3xl md:text-4xl font-bold dark:text-white text-gray-900">Estadísticas</h1>
            <p className="dark:text-gray-400 text-gray-600 mt-1">
              Análisis detallado del crecimiento y actividad de la plataforma.
            </p>
          </div>
        </div>
      </motion.div>
