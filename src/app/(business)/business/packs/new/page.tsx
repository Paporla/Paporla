...
export default async function NewPackPage() {
  ...
  const { data, error: shopError } = await supabase.rpc('get_my_shop')
  ...
  const shop = (data as MyShopPayload | null)?.shop

  if (!shop?.id || shop.deleted_at) {
    redirect('/business/profile')
  }
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="dark:text-gray-400 text-gray-600 max-w-2xl">
                  Tu comercio esta suspendido temporalmente. No puedes crear nuevos packs en este momento.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="dark:text-gray-400 text-gray-600 max-w-2xl mb-6">
                  Cuando el administrador verifique tu comercio, podras publicar packs. El borrador se habilita tras la
                  verificacion en esta version.
                </p>
        ...
        <div className="relative">
          ...
          <div className="flex justify-between items-start flex-wrap gap-4">
            <div>
              ...
              <p className="dark:text-gray-400 text-gray-600 max-w-2xl">
                Se guarda como borrador. Para publicarlo haran falta alergenos e imagen.
              </p>
            </div>
