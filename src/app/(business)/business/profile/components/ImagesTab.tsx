  ...
  return (
    <div className="bg-black/40 backdrop-blur-sm border border-white/10 rounded-2xl p-6 lg:p-8 space-y-8">
      ...
      <div className="bg-black/40 border border-white/10 rounded-xl p-4">
        <p className="text-xs text-gray-500 flex items-center gap-2"><AlertTriangle className="w-4 h-4 text-yellow-400" />Las imagenes de alta calidad aumentan las reservas un 40%. Usa fotos reales de tu local.</p>
      </div>
    </div>
  );
}