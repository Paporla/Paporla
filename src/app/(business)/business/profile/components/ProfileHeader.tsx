    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-transparent to-secondary/5 -mt-8 -mx-4 px-4 py-8 rounded-b-3xl">
      <div className="relative flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={onPreview} className="flex items-center gap-2 dark:bg-black/40 bg-gray-100 dark:border-white/10 border-gray-200 rounded-xl px-4 py-2 text-sm dark:text-gray-400 text-gray-600 hover:dark:text-white hover:text-gray-900 hover:border-primary/30 transition-all">
      ...
      {!verified && (
        <div className="mt-4 flex items-center gap-2 bg-yellow-500/5 border border-yellow-500/20 rounded-xl px-4 py-3">
          ...
          <p className="text-xs text-yellow-300"><span className="font-semibold">Pendiente de verificacion</span> -- Tu comercio sera revisado en las proximas 24-48 horas.</p>
        </div>
      )}
    </div>
  );
