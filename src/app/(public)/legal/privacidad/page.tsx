          ...
          <div className="lg:col-span-3 space-y-6">
              ...
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-center gap-2">
                        <CheckCircle className="w-4 h-4 text-green-500" />
                        Preferencias de búsqueda y filtros
                      </li>
                      <li className="flex items-center gap-2">
                        <CheckCircle className="w-4 h-4 text-green-500" />
                        Comercios favoritos
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-center gap-2">
                        <CheckCircle className="w-4 h-4 text-green-500" />
                        Datos de geolocalización (con tu consentimiento)
                      </li>
                      <li className="flex items-center gap-2">
                        <CheckCircle className="w-4 h-4 text-green-500" />
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-primary mb-3 flex items-center gap-2">
                      ...
                      Información de comercios (adicional):
                    </h3>
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2">
                        <CheckCircle className="w-4 h-4 text-green-500" />
                ...
                <div className="mt-4 p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
                  <p className="text-sm flex items-start gap-2">
                    ...
                    <span>
                      <strong>Nota importante:</strong> No recopilamos datos sensibles como información médica,
                      orientación sexual, creencias religiosas o afiliación política.
                    </span>
                  </p>
                </div>
              </div>
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <div className="grid md:grid-cols-2 gap-3 mt-4">
                  <div className="flex items-start gap-2 p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Operar y mejorar la plataforma Paporla
                  </div>
                  <div className="flex items-start gap-2 p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Procesar reservas y gestionar tu cuenta
                  </div>
                  <div className="flex items-start gap-2 p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Comunicarnos sobre tus reservas y novedades
                  </div>
                  <div className="flex items-start gap-2 p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                  ...
                  <div className="flex items-start gap-2 p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Prevenir fraudes y actividades fraudulentas
                  </div>
                  <div className="flex items-start gap-2 p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                  ...
                  <div className="flex items-start gap-2 p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Realizar análisis estadísticos y mejoras del servicio
                  </div>
                  <div className="flex items-start gap-2 p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Enviar ofertas y promociones (con tu consentimiento)
                  </div>
                </div>
              </div>
            </motion.section>
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <p className="dark:text-gray-300 text-gray-700 mb-3">
                  <strong className="text-primary">Paporla NO vende ni alquila sus datos personales.</strong>{' '}
                ...
                <div className="space-y-4 mt-4">
                  <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
                    ...
                    <p className="text-sm mt-1">
                      Compartimos su nombre y teléfono con los comercios donde realiza reservas para gestionar la
                      recogida de packs.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-purple-500/10 border border-purple-500/20">
                    ...
                    <p className="text-sm mt-1">
                      Compartimos datos con proveedores que nos ayudan a operar (hosting, email, análisis), siempre bajo
                  ...
                  <div className="p-4 rounded-xl bg-yellow-500/10 border border-yellow-500/20">
                    ...
                    <p className="text-sm mt-1">
                      Podemos compartir información si es requerido por ley o para proteger derechos y seguridad.
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <div className="mt-4 p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
                  <p className="text-sm">
                    🔒 <strong>Certificaciones:</strong> Nuestra infraestructura cumple con estándares internacionales
                    de seguridad (SOC 2, ISO 27001) a través de nuestros proveedores Supabase y Vercel.
                  </p>
                </div>
              </div>
            </motion.section>
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <p className="dark:text-gray-300 text-gray-700">
                  Utilizamos cookies y tecnologías similares para mejorar su experiencia. Para más detalles sobre qué
                  cookies usamos y cómo gestionarlas, consulte nuestra{' '}
                ...
                <div className="mt-4 flex flex-wrap gap-3">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <strong>Esenciales:</strong> Autenticación y reservas
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <span className="w-2 h-2 rounded-full bg-blue-500"></span>
                    <strong>Preferencias:</strong> Modo oscuro, idioma
                  </div>
                  <div className="flex items-center gap-2 text-sm">
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <p className="dark:text-gray-300 text-gray-700">
                  Conservamos sus datos personales mientras su cuenta esté activa. Tras la cancelación de su cuenta:
                </p>
                <ul className="list-none mt-3 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    Datos anonimizados: <strong>Pueden conservarse indefinidamente</strong> para análisis estadísticos
                  </li>
                </ul>
              </div>
            </motion.section>
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <p className="dark:text-gray-300 text-gray-700">
                  Paporla no está dirigida a menores de 18 años. No recopilamos conscientemente información de personas
                  menores de edad. Si descubrimos que hemos recopilado datos de un menor sin consentimiento parental,
                  los eliminaremos inmediatamente.
                </p>
                <div className="mt-4 p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                  <p className="text-sm">
                    ⚠️ <strong>Reporte:</strong> Si eres padre/tutor y crees que tu hijo menor ha proporcionado datos en
                    Paporla, contáctanos a <strong>datos@paporla.com</strong>
                  </p>
                </div>
              </div>
            </motion.section>
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <p className="dark:text-gray-300 text-gray-700">
                  Sus datos pueden ser procesados en servidores ubicados en diferentes países (Estados Unidos, Brasil,
                  Unión Europea). En todos los casos:
                </p>
                <ul className="list-none mt-3 space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5" />
                    Garantizamos un nivel adecuado de protección
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5" />
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5" />
                    Utilizamos acuerdos de transferencia estandarizados
                  </li>
                </ul>
              </div>
            </motion.section>
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <ul className="list-none mt-3 space-y-2">
                  <li className="flex items-start gap-2">
                    <Mail className="w-4 h-4 text-primary mt-0.5" />
                    Correos electrónicos sobre tu reserva y estado
                  </li>
                  <li className="flex items-start gap-2">
                    <Bell className="w-4 h-4 text-primary mt-0.5" />
                    Notificaciones push sobre ofertas y novedades
                  </li>
                  <li className="flex items-start gap-2">
                    <MessageCircle className="w-4 h-4 text-primary mt-0.5" />
                    Mensajes de WhatsApp (solo si lo autorizas)
                  </li>
                </ul>
                <p className="mt-3">
                  Puedes darte de baja en cualquier momento desde la configuración de tu cuenta o mediante el enlace en
                  cada comunicación.
                </p>
              </div>
            </motion.section>
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <p className="dark:text-gray-300 text-gray-700">
                  Actualizaremos esta política periódicamente. Los cambios significativos se comunicarán por email o
                  mediante un aviso destacado en la plataforma. La fecha de la última actualización siempre estará
                  visible al inicio del documento.
                </p>
                <div className="mt-4 p-4 rounded-lg bg-primary/5 text-center">
                  <p className="text-sm">
                    📋 <strong>Historial de versiones:</strong> Puedes consultar versiones anteriores de esta política
                    solicitándolas a datos@paporla.com
                  </p>
                </div>
              </div>
            </motion.section>
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <p className="dark:text-gray-300 text-gray-700 mb-3">
                  Si tienes preguntas sobre esta política o sobre tus datos personales:
                </p>
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <Mail className="w-5 h-5 text-primary" />
                    📧 <strong>Email:</strong>{' '}
                    <a href="mailto:datos@paporla.com" className="text-primary hover:underline">
                      datos@paporla.com
                    </a>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-lg dark:bg-white/5 bg-gray-100">
            ...
            >
              ...
              <div className="flex flex-wrap justify-center gap-4 text-sm">
                <a href="/legal/terminos" className="flex items-center gap-1 text-primary hover:underline">
                  <FileText className="w-3 h-3" />
                  Términos
                </a>
                <span className="text-gray-500">|</span>
                <a href="/legal/cookies" className="flex items-center gap-1 text-primary hover:underline">
                  <Cookie className="w-3 h-3" />
                  Cookies
                </a>
                <span className="text-gray-500">|</span>
                <a href="/contacto" className="flex items-center gap-1 text-primary hover:underline">
                  <Mail className="w-3 h-3" />
                  Contacto DPO
                </a>
              </div>
              <p className="text-xs text-gray-500 mt-4">
                © {new Date().getFullYear()} Paporla - Todos los derechos reservados. Delegado de Protección de Datos:
                datos@paporla.com
              </p>
            </motion.div>
          </div>
