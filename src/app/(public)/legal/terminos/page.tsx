          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <div className="space-y-3 dark:text-gray-300 text-gray-700 leading-relaxed">
                  <p>
                    Al acceder y utilizar la plataforma Paporla (incluyendo el sitio web y aplicaciones móviles), usted
                    acepta cumplir con estos Términos y Condiciones. Si no está de acuerdo con alguna parte de estos
                  ...
                  <div className="p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20 mt-4">
                    <p className="text-sm flex items-start gap-2">
                      ...
                      <span>
                        Al registrarte, confirmas que tienes al menos 18 años de edad o cuentas con autorización
                        parental para utilizar nuestros servicios.
                      </span>
                    </p>
                  </div>
                </div>
              ...
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <div className="grid gap-4">
                  <div className="p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <strong className="text-primary">Paporla:</strong> Plataforma tecnológica que conecta comercios con
                    excedentes alimentarios y usuarios interesados en rescatarlos.
                  </div>
                  <div className="p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <strong className="text-primary">Pack:</strong> Producto o conjunto de productos alimenticios
                    ofrecidos por un comercio a través de la plataforma.
                  </div>
                  <div className="p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <strong className="text-primary">Comercio:</strong> Establecimiento comercial registrado en Paporla
                    que ofrece packs.
                  </div>
                  <div className="p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <strong className="text-primary">Usuario:</strong> Persona natural que utiliza la plataforma para
                    reservar packs.
                  </div>
                  <div className="p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <strong className="text-primary">Reserva:</strong> Acción mediante la cual un usuario aparta un pack
                    para su recogida.
                  </div>
                  <div className="p-3 rounded-lg dark:bg-white/5 bg-gray-100">
                    <strong className="text-primary">Código de recogida:</strong> Identificador único generado al
                    reservar, necesario para retirar el pack.
                  </div>
                </div>
              </div>
            </motion.section>
              ...
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <ul className="list-none space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    Proporcionar información veraz, precisa y actualizada durante el registro.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    No realizar reservas fraudulentas o sin intención real de recoger el pack.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Respetar los horarios de recogida establecidos por cada comercio.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    No revender los packs adquiridos a través de la plataforma.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Reportar cualquier problema o irregularidad a través de los canales oficiales.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <p className="dark:text-gray-300 text-gray-700 mb-3">
                  Los comercios registrados en Paporla se comprometen a:
                </p>
                <ul className="list-none space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Ofrecer productos en condiciones aptas para el consumo humano.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Respetar las fechas y horarios de recogida acordados.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Mantener actualizada la información de sus packs (disponibilidad, precios, horarios).
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    No discriminar a ningún usuario por ningún motivo.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Cumplir con todas las normas sanitarias vigentes en su localidad.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Proporcionar un ambiente seguro para la recogida de los packs.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Responder prontamente a las consultas y solicitudes de los usuarios.
                  </li>
                </ul>
              </div>
            </motion.section>
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <p className="dark:text-gray-300 text-gray-700 mb-3">
                  Las reservas en Paporla se realizan de forma gratuita y se confirman de inmediato. Al realizar una
                  reserva, usted acepta:
                </p>
                <ul className="list-none space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Recoger el pack dentro del horario establecido por el comercio.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Presentar el código de recogida generado por la plataforma.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Pagar directamente al comercio el monto acordado del pack.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                ...
                <div className="mt-4 p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
                  <p className="text-sm flex items-start gap-2">
                    ...
                    <span>El código de recogida es personal e intransferible. No compartas este código con nadie.</span>
                  </p>
                </div>
              </div>
            </motion.section>
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <div className="mt-4 p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                  <p className="text-sm">
                    💰 <strong>Consejo:</strong> Lleva el cambio exacto para agilizar el proceso de recogida.
                  </p>
                </div>
              </div>
            </motion.section>
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <p className="dark:text-gray-300 text-gray-700">
                  Paporla actúa únicamente como intermediario tecnológico entre comercios y usuarios. No somos
                  responsables por:
                </p>
                <ul className="list-none space-y-2 mt-3">
                  <li className="flex items-start gap-2">
                    <AlertCircle className="w-4 h-4 text-yellow-500 mt-0.5 flex-shrink-0" />
                    La calidad, cantidad o seguridad de los productos ofrecidos por los comercios.
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertCircle className="w-4 h-4 text-yellow-500 mt-0.5 flex-shrink-0" />
                    Retrasos o problemas en la recogida causados por los comercios.
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertCircle className="w-4 h-4 text-yellow-500 mt-0.5 flex-shrink-0" />
                    Daños derivados del consumo de productos adquiridos a través de la plataforma.
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertCircle className="w-4 h-4 text-yellow-500 mt-0.5 flex-shrink-0" />
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <ul className="list-none space-y-2 mt-3">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Recopila únicamente los datos necesarios para el funcionamiento de la plataforma.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    No comparte datos personales con terceros sin consentimiento explícito.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Implementa medidas de seguridad para proteger la información de los usuarios.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                    Permite a los usuarios acceder, rectificar y eliminar sus datos personales.
                  </li>
                </ul>
                <p className="mt-3">
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <p className="dark:text-gray-300 text-gray-700">
                  Paporla se reserva el derecho de modificar estos términos en cualquier momento. Las modificaciones
                  entrarán en vigor inmediatamente después de su publicación en la plataforma. Es responsabilidad del
                  usuario revisar periódicamente los términos actualizados.
                </p>
              </div>
            </motion.section>
            ...
            >
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <p className="dark:text-gray-300 text-gray-700 mt-3">
                  ...
                  la jurisdicción de los tribunales de cada país.
                </p>
              </div>
            </motion.section>
              ...
              <div className="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-sm">
                ...
                <div className="space-y-2">
                  <p className="flex items-center gap-2">
                    <Mail className="w-4 h-4 text-primary" /> Email legal:{' '}
                    <a href="mailto:legal@paporla.com" className="text-primary hover:underline">
                      legal@paporla.com
                    </a>
                  </p>
                  <p className="flex items-center gap-2">
                ...
                <div className="mt-6 p-4 rounded-lg bg-gradient-to-r from-primary/10 to-secondary/10">
                  <p className="text-sm text-center">
                    📄 <strong>Nota final:</strong> Estos términos están diseñados para proteger tanto a usuarios como a
                    comercios, promoviendo una comunidad de consumo responsable y reducción del desperdicio alimentario.
                  </p>
                </div>
              </div>
            </motion.section>
            ...
            >
              <div className="flex flex-wrap justify-center gap-4 text-sm">
                <a href="/legal/privacidad" className="flex items-center gap-2 text-primary hover:underline">
                  <Shield className="w-4 h-4" />
                  Política de Privacidad
                </a>
                <span className="text-gray-500">|</span>
                <a href="/legal/cookies" className="flex items-center gap-2 text-primary hover:underline">
                  <Cookie className="w-4 h-4" />
                  Política de Cookies
                </a>
                <span className="text-gray-500">|</span>
                <a href="/contacto" className="flex items-center gap-2 text-primary hover:underline">
                  <Mail className="w-4 h-4" />
                  Contacto
                </a>
              </div>
              <p className="text-xs text-gray-500 mt-4">
                © {new Date().getFullYear()} Paporla - Rescate Alimentario. Todos los derechos reservados.
              </p>
            </motion.div>
          </div>
        </div>
...
function Cookie(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
