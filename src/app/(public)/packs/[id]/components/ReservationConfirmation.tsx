  ...
  return (
    ...
    >
      ...
      <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6 text-center mb-6">
        <p className="text-sm text-gray-400 mb-2">Tu código de recogida</p>
        <p className="text-4xl font-bold text-primary tracking-widest font-mono mb-3">
          {pickupCode}
        </p>
        <CopyButton text={pickupCode} label="Copiar código" />
      </div>

      <div className="bg-white/5 rounded-xl p-4 mb-6 space-y-2">
        <div className="flex justify-between text-sm">
          <span className="text-gray-400">Pack</span>
          <span className="text-white font-medium">{packTitle}</span>
        </div>
        <div className="flex justify-between text-sm">
      ...
      <div className="text-xs text-gray-500 text-center mb-6 space-y-2">
        <p>💡 Muestra este código al llegar al comercio para retirar tu pack.</p>
