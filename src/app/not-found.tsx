  ...
  return (
    <div className="min-h-screen dark:bg-[#0a0a0f] bg-gray-50 flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        {/* Texto */}
        <h1 className="text-2xl font-bold dark:text-white text-gray-900 mb-3">Pagina no encontrada</h1>
        <p className="dark:text-gray-400 text-gray-600 mb-8 leading-relaxed">
          Esta pagina no existe o fue eliminada. Pero no te preocupes, aun hay mucha comida esperando ser rescatada.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-primary to-primary/80 text-white dark:text-black font-medium hover:opacity-90 transition-all"
          >
        ...
        {/* Footer sutil */}
        <p className="mt-12 text-xs dark:text-gray-600 text-gray-400">Paporla -- Rescata comida, no la dejes perder</p>
      </div>
    </div>
  )
}
