...
const COLORS = { primary: '#00ff88', secondary: '#ff8a3c', purple: '#00cc6e', blue: '#e67320' }
            ...
            <Card glass className="p-5">
              <div className="flex items-start justify-between mb-3">
                ...
                {growthVal !== undefined && growthVal !== 0 && (
                  <span
                    className={`flex items-center gap-0.5 text-[11px] font-medium px-2 py-0.5 rounded-lg ${growthVal > 0 ? 'text-green-400 bg-green-500/10' : 'text-red-400 bg-red-500/10'}`}
                  >
