    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-transparent to-secondary/5 -mt-8 -mx-4 px-4 py-8 rounded-b-3xl">
      ...
      <div className="relative">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-3xl md:text-4xl font-bold dark:text-white text-gray-900">{shop.name}</h1>
        ...
        <p className="dark:text-gray-400 text-gray-600 mt-2">Gestiona tus packs y reservas desde aquí</p>
      </div>
    </div>
  )
}
