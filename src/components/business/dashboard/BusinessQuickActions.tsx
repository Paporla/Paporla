...
const actions = [
  ...
  { icon: BarChart3, label: 'Analytics', href: '/business/analytics', color: 'from-amber-500 to-orange-500', description: 'Ver métricas', bg: 'bg-amber-500/10' },
];
        ...
        {actions.map((action, idx) => (
          ...
          >
            <Link href={action.href}>
              <div className="group bg-dark-card border border-dark-border hover:border-primary/30 rounded-2xl p-4 text-center cursor-pointer transition-all duration-300 hover:-translate-y-1">
