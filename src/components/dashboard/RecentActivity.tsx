...
export default function RecentActivity({ activities = [] }: RecentActivityProps) {
  ...
  return (
    <div className="glass-card rounded-2xl overflow-hidden">
      <div className="flex items-center justify-between p-5 pb-3 border-b dark:border-white/10 border-gray-200">
        <div>
            ...
            <div key={group.title}>
              ...
              <AnimatePresence>
                {isExpanded && (
                  ...
                  >
                    <div className="divide-y dark:divide-white/5 divide-gray-200 border-t dark:border-white/10 border-gray-200">
