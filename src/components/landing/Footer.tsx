...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-white/10 py-8 md:py-10 mt-8 md:mt-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs md:text-sm text-gray-500">
          ...
          <motion.p whileHover={{ scale: 1.05 }} className="flex items-center gap-1">
            © {currentYear} Paporla · Hecho con <Heart className="w-3 h-3 text-primary inline" /> para el planeta
          </motion.p>
        </div>
      </div>
    </footer>
