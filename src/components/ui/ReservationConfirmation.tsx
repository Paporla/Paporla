    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-5">
          ...
          {/* Compartir rescate */}
          <div className="border-t dark:border-gray-700 border-gray-200 pt-4 text-center">
            <p className="text-xs text-gray-500 mb-3">Comparte tu rescate y presume de ahorro 💪</p>
            <ShareButton
              title="¡Acabo de rescatar comida en Paporla! 🥗"
              text={`Acabo de reservar "${reservation.pack.title}" en ${reservation.shop.name}. ¡Tú también puedes ahorrar y ayudar al planeta! 🌍`}
              variant="pill"
              size="md"
            />
          </div>
