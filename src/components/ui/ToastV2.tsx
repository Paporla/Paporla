...
export default function ToastV2({ message, type = 'info', onClose, duration = 4000 }: ToastV2Props) {
  useEffect(() => {
  ...
  const config = {
    ...
    success: { icon: CheckCircle, color: 'bg-green-500/20 border-green-500/40 text-green-400', iconColor: 'text-green-400' },
