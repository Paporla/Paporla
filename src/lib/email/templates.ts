...
export function welcomeTemplate(name: string) {
  return baseLayout(`
<h2 style="color:#fff;font-size:28px;margin:0 0 4px;text-align:center;font-weight:800;">Bienvenido a bordo! 🌱</h2>
